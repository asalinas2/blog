...
<html>
    <head>
        <title>TechBOOM &raquo; Edit Profile</title>
    ...
    <body>
        ...
        <a class="nav" href="index?action=upload">Upload a profile picture.</a>
        <a class="nav" href="index?action=home">Take me home.</a>    
    </div>
